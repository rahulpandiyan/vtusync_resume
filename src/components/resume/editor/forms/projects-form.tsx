          ...
          >
            ...
            <CardContent className="p-3 sm:p-4 space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                {/* Description Section */}
                <div className="space-y-2 sm:space-y-3">
                  <Label className="text-[10px] sm:text-xs font-medium text-zinc-900 dark:text-zinc-100">
                  ...
                  <div className="space-y-2 pl-0">
                    ...
                    {project.description.length === 0 && !aiSuggestions[index]?.length && (
                      <div className="text-[10px] sm:text-xs text-zinc-500 italic px-4 py-3 bg-zinc-50 dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800">
