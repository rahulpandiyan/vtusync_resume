            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="relative group">
                <Input
                  ...
                  className={cn(
                    "w-full h-9 bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-lg",
                    "focus:border-zinc-400 focus:ring-zinc-400 dark:focus:border-zinc-600 dark:focus:ring-zinc-600",
                    "transition-colors",
                    "text-[10px] sm:text-xs"
                  )}
              ...
              <div className="flex items-center space-x-2 -mt-1">
                <span className="text-[8px] sm:text-[10px] text-zinc-500">Use &apos;Present&apos; in the date field for current education</span>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-baseline">
                  <Label className="text-[10px] sm:text-xs font-medium text-zinc-900 dark:text-zinc-100">Achievements & Activities</Label>
                  <span className="text-[8px] sm:text-[10px] text-zinc-500">One achievement per line</span>
                </div>
                <Tiptap
                  ...
                  className={cn(
                    "min-h-[120px] bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 rounded-lg",
