    ...
    <section className="relative py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-zinc-900 dark:text-zinc-50">
            How ResuSync Works
          </h2>
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute top-[25%] left-[25%] w-96 h-96 bg-zinc-200/20 dark:bg-zinc-800/20 rounded-full blur-3xl" />
          <div className="absolute bottom-[25%] right-[25%] w-96 h-96 bg-zinc-200/20 dark:bg-zinc-800/20 rounded-full blur-3xl" />
        </div>
      </div>
    </section>
  );
